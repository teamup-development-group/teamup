...
function buildApp(appPath, meteorBinary, buildLocaltion, serverArchitecture, callback) {
  buildMeteorApp(appPath, meteorBinary, buildLocaltion, serverArchitecture, function(code) {
    if(code == 0) {
...
function buildMeteorApp(appPath, meteorBinary, buildLocaltion, serverArchitecture, callback) {
